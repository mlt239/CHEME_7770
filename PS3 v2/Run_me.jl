...
flux_bounds_array = [
  0.0	E*(203*3600)	;	# 1	ATP + Citrulline + Asparate > AMP + diphosphate + Arginosuccinate
  0.0	E*(34.5*3600)	;	# 2	Arginosuccinate > Fumarate + Arginine
  0.0	E*(249*3600)	;	# 3	Arginine + H2O > Ornithine + Urea
  0.0	E*(88.1*3600)	;	# 4	Ornithine + Carbamoyl Phosphate > Citrulline +orthophosphate
  0.0	E*(13.7*3600) ;	# 5	2 Arginine + 3 NADPH + 3 H + 4 O2 > 2 Citrulline + 2 Nitric oxide + 3 NADP + 4 H2O
