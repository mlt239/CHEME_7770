...
s = readdlm("stoichiometric_v3.txt");
...
#Next, we have the exchanges. These are defined in the problem, as well as their directions.
...
#So these down here are necessary to generate fluxes, also defined in problem. Decided to open all of these up.
  -10.0	10.0	;	# 11	> NADPH*
  -10.0	10.0	;	# 12	> ATP
  -10.0	10.0	;	# 13	> H*
  -10.0	10.0	;	# 14	> H2O*
  ...
  0.034657359 0.034657359 ;	# 21	Growth, this is necessary to include dilution terms
];
